...
export default function FeaturePage() {
  const items = [
    { t: "Feb 14 — Lab Results Received", d: "CBC normal • Lipid panel: LDL elevated (142) • A1C: 5.8%", s: "result" },
    { t: "Feb 10 — Office Visit", d: "Chief complaint: fatigue • Ordered labs • Follow-up in 2 weeks", s: "visit" },
    { t: "Jan 28 — Prescription Filled", d: "Metformin 500mg • 90-day supply • Auto-refill enabled", s: "rx" },
    { t: "Jan 15 — Annual Physical", d: "BP: 128/82 • BMI: 26.4 • Recommended lifestyle changes", s: "visit" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Case Timeline</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Patient case chronological overview</p>
