...
const FROM = process.env.EMAIL_FROM || 'ClaimResolve - Medical Billing Dispute Manager <noreply@example.com>';
const APP_NAME = 'ClaimResolve - Medical Billing Dispute Manager';
